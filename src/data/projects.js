    ...
    projects: [
      {
        ...
        description: 'Delivered measurable organic growth across a portfolio of high-growth SaaS clients. Led strategy at the account level — content architecture, keyword targeting, link building, and technical improvements — turning organic into a primary acquisition channel for both.',
        tags: ['Content SEO', 'Programmatic SEO', 'Link Building', 'SaaS'],
        cases: [
          {
            id: 'case-holded',
            client: 'Holded',
            type: 'ERP & Invoicing · Spain',
            description: 'Scaled organic signups 4.5x in under 12 months. Built a bottom-of-funnel content strategy targeting Spanish-language accounting and invoicing keywords — converting searchers into product signups and reducing dependence on paid acquisition.',
            metrics: [
              '1,370% growth in organic non-branded signups',
              '279% increase in MRR from organic',
              '1,650% increase in paid subscriptions from organic',
            ],
            thumbnail: '/assets/images/skale-holded.webp',
            url: 'https://skale.so/stories/holded/',
          },
          {
            id: 'case-maze',
            client: 'Maze',
            type: 'User Research Platform',
            description: 'Grew monthly organic signups 283%+ in under 6 months. Restructured content around product use cases, improved site architecture for topic authority, and acquired 200+ high-quality backlinks — positioning Maze as an industry reference against Hotjar and Usability Geek.',
            metrics: [
              '4x increase in organic visits (non-branded)',
              '3x increase in organic product signups',
              '2x increase in signup conversion rate',
            ],
            thumbnail: '/assets/images/skale-maze.webp',
            url: 'https://skale.so/stories/maze/',
          },
        ],
      },
    ],
